<!-- For requests we can have request category request status request date so we can add requests or update them -->
<?php 
session_start();
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $sql = "SELECT request_id, request, financial_category.category_name , request_status, request_date FROM requests left join financial_category on requests.category_id = financial_category.category_id";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                       ...
                       $record .= "<tr>
                                ...
                                <td>" . $requestdate. "</td>
                                <td>
                                <a class='btn btn-danger' href='action/requests-operations.php?action=deleterequest&rid=" . urlencode($requestid) .  "' role='button'>Delete</a>
                                </td>
                            </tr>";
                    ...
                    $record = "<tr><td colspan='4'>No Requests found</td></tr>";
                }
