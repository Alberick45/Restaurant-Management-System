<!-- For staff we have staff id staff name position department salary phone access level staff_points so can add staff or fire staff or promote or demote-->
<?php 
session_start();
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $sql = "SELECT staff_id,staff_name,phone_number,age,password,salary , department.department_name FROM staff left join department on position_id = department_id";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $staffnumber = htmlspecialchars($row["phone_number"]);
                       ...
                       $record .= "<tr>
                                ...
                                <td>" . $salary. "</td>
                                <td>
                                <a class='btn btn-danger' href='actions/staff-operations.php?action=deletestaff&sid=" . urlencode($staffid) .  "' role='button'>Delete</a>
                                </td>
                            </tr>";
                    ...
                    $record = "<tr><td colspan='4'>No staff available</td></tr>";
                }
