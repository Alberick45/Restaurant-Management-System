<!-- For revies we have customer name review suggestion so we can add suggestion or edit suggestion  -->
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                       ...
                       $record .= "<tr>
                                ...
                                <td>" . $suggestion. "</td>
                                <td>
                                <a class='btn btn-danger' href='action/review-operations.php?action=deletereview&rvid=" . urlencode($reviewid) .  "' role='button'>Delete</a>
                                </td>
                            </tr>";
