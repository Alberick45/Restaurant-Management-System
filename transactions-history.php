<!-- For transactions history  so shows transaction id item categoryoftransaction quantity price and date available procedures add teransactions so its linked to place orders and staff so just show transactions or add transaction manually when inputting money or paying for something -->
<?php 
session_start();
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $sql = "SELECT transaction_id, transaction_item, financial_category.category_name , transaction_quantity, total_price, transaction_date FROM transactions left join financial_category on transactions.category_id = financial_category.category_id";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                       ...
                       $record .= "<tr>
                                <td>" .  $transactionid. "</td>
                                <td>" .  $transactionitem. "</td>
                                <td>" .  $categoryname  . "</td>
                                <td>" . $transactionquantity. "</td>
                                <td>" . $totalamount. "</td>
                                <td>" . $transactiondate. "</td>
                                <td>
                                <a class='btn btn-danger' href='action/transactions-operations.php?action=deletetransaction&tid=" . urlencode($transactionid) .  "' role='button'>Delete</a>
                                </td>
                            </tr>";
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="php/customer_upload.php"  id="signin" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
          <div class="input-group mb-3">
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="customer-operations.php" method = 'POST' id="customer" class="needs-validation" novalidate>
